...
export const ui = {
  it: {
    ...
    "home.carousel.prev": "Progetti precedenti",
    "home.carousel.next": "Progetti successivi",
    "home.carousel.page": "Pagina {n} di {total}",
    // Posts
    ...
    // Home
    "home.description_intro": "Uno spazio dove la curiosità si trasforma in codice.",
    "home.description": "App mobile con Flutter, Dart e SwiftUI, siti web e temi WordPress su misura. Ogni progetto punta su semplicità d'uso, prestazioni e privacy.",
    "home.description_blog": "Il blog racconta il lato tecnologico: AI, sicurezza digitale e le tendenze che cambiano il modo in cui lavoriamo e viviamo online.",
  ...
  en: {
    ...
    "home.carousel.prev": "Previous projects",
    "home.carousel.next": "Next projects",
    "home.carousel.page": "Page {n} of {total}",
    "home.description_intro": "A space where curiosity turns into code.",
    "home.description": "Mobile apps with Flutter, Dart, and SwiftUI, plus custom websites and WordPress themes. Every project focuses on ease of use, performance, and privacy.",
    "home.description_blog": "The blog covers the tech side: AI, digital security, and the trends reshaping the way we work and live online.",

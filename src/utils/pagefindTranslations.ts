// Official Italian strings bundled with @pagefind/default-ui (translations/it.json),
// passed explicitly since PagefindUI doesn't auto-select a locale from <html lang>.
export const PAGEFIND_IT_TRANSLATIONS = {
  placeholder: "Cerca",
